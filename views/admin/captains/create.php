...
.branch-card input[type="checkbox"] {
    position: absolute;
    opacity: 0;
    width: 0;
    height: 0;
...
.branch-card-inner .branch-icon {
    font-size: 1.4rem;
    line-height: 1;
}

.branch-card-inner .branch-label {
    font-size: .82rem;
    font-weight: 500;
    color: var(--text, #333);
    line-height: 1.3;
...
.branch-card-inner .branch-disabled-tag {
    font-size: .68rem;
    color: var(--muted);
...
.branch-card input:checked + .branch-card-inner .branch-icon::after {
    content: ' ✓';
    font-size: .9rem;
}
