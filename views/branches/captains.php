...
<div class="page">
    ...
    <div class="breadcrumb">
        ...
        <span>كباتن الفرع #<?= $branchId ?></span>
    </div>

    <div class="page-header">
        <div>
            <h1 class="page-header__title">كباتن الفرع</h1>
            ...
            <table class="data-table">
                ...
                <tbody>
                    <?php if ($captains): ?>
                        ...
                        <tr>
                            <td><?= $c['id'] ?></td>
                            <td style="font-weight:600"><?= htmlspecialchars($c['captain_name'] ?? '—') ?></td>
                            <td><?= htmlspecialchars($c['phone_number'] ?? '—') ?></td>
                            <td><?= $c['created_at'] ?? '—' ?></td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="4"><div class="empty-state"><p>لا يوجد كباتن مسجلون في هذا الفرع</p></div></td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
